...
{\centering \ovalbox{\large ¡¡ Dû le 8 mars à 23h59 !!} \\}
...
Les réponses du serveur sont toujours soit \kw{ACK} soit \kw{ERR}, comme
...
\texttt{rapport.tex} dans une archive \kw{tar} par la page Moodle (aussi
